...
using BookingApp.Flight.Domain.Flights;
...
namespace BookingApp.Flight.Infra.Seed
{
    public class FlightDataSeeder : IDataSeeder
    {
        ...
        private async Task SeedFlightAsync()
        {
            ...
            {
                var flights = new List<Domain.Flights.Flight>
            {
               Domain.Flights.Flight.Create(1, "BD467", 1, 1, new DateTime(2022, 1, 31, 12, 0, 0),
